...
Sur le plan fonctionnel, « SALISA » propose un ensemble de fonctionnalités répondant aux besoins réels du marché congolais : mise en correspondance intelligente entre prestataires et demandeurs, système de confiance à plusieurs niveaux avec badges de certification, paiement sécurisé par Mobile Money, messagerie en temps réel et notifications multi-canaux par e-mail et SMS. L'application est conçue comme une \textit{Progressive Web Application} (PWA), optimisée pour les réseaux mobiles et accessible sans installation.
