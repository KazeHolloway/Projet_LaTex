...
\subsection*{Paiement mobile via API}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_accueil.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_inscription.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_otp.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_choix_role.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_dashboard_demandeur.png}
	\caption{Tableau de bord du demandeur}
	\label{fig:cap_dashboard_demandeur}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_publication_mission.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_recherche_prestataires.png}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=0.85\textwidth]{captures_appli/capture_messagerie.png}
%	\caption{Interface de messagerie entre demandeur et prestataire}
%	\label{fig:cap_messagerie}
%\end{figure}

%\begin{figure}[H]
%	\centering
%	\includegraphics[width=0.85\textwidth]{captures_appli/capture_paiement.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{captures_appli/capture_dashboard_prestataire.png}
	\caption{Tableau de bord du prestataire}
	\label{fig:cap_dashboard_prestataire}
\end{figure}