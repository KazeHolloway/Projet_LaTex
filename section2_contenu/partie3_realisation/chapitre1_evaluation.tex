...
\begin{table}[H]
	...
	\begin{tabular}{|p{4.5cm}|c|p{4.5cm}|p{3.2cm}|}
		...
		% les colonnes Prix unitaire et total simplement centrées
		
		%\multicolumn{1}{p{4.5cm}}{\centering\arraybackslash\textcolor{white}{\textbf{Prix unitaire\newline (en FCFA)}}} &
		%\multicolumn{1}{p{3.2cm}}{\centering\arraybackslash\textcolor{white}{\textbf{Prix total\newline (en FCFA)}}} \\
		
		% les colonnes Prix unitaire et total parfaitement centrées		
