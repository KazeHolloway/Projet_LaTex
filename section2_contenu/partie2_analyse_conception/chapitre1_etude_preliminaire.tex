...
\vspace{0.3cm}
Il s'agit de développer une application web progressive (PWA), accessible depuis tous les terminaux sans installation obligatoire. Elle intègre des fonctionnalités complètes, à savoir la gestion des profils, la publication de missions, la messagerie, la mise en correspondance intelligente entre prestataires et clients, le règlement des missions via MTN MoMo ou Airtel Money, et le système de notation. C'est la solution que nous avons retenue pour « SALISA ».
...
Notre choix se porte sur la \textbf{solution 2 : développement d'une application web cross-plateforme (PWA)}.
