...
\vspace{0.4cm}
\noindent\textbf{b- Solution 2 : développement d'une application web cross-plateforme (PWA-like) avec matching intelligent et paiement sécurisé}
