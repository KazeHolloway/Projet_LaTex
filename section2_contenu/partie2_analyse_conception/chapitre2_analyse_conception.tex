...
\begin{itemize}[label=\textbf{-}]
	...
	\item choix du rôle lors de l'inscription (prestataire ou demandeur) ;
	...
	\item paiement sécurisé via MTN MoMo et Airtel Money \cite{mtn_momo} ;
	\item validation de la mission terminée et confirmation du paiement au prestataire ;
	\item notation et dépôt d'avis après chaque mission réalisée ;
	\item notifications multi-canaux (push PWA, e-mail, SMS) ;
...
\begin{itemize}[label=\textbf{-}]
	...
	\item performance : temps de réponse des API inférieur à 2 secondes pour 95\% des requêtes. Ce seuil est fondé sur les recommandations générales en ergonomie web, selon lesquelles un délai supérieur à 2 secondes provoque une baisse perceptible du confort d'utilisation, surtout sur réseau mobile. Compte tenu de l'usage majoritairement mobile de SALISA et des connexions parfois limitées à Brazzaville, ce seuil constitue un équilibre raisonnable entre performance cible et faisabilité technique ;
	
	\item disponibilité cible de 99,5\% ;
	\item intégration des API de paiement mobile : MTN MoMo et Airtel Money \cite{mtn_momo} ;
...
\vspace{0.3cm}
\noindent\textbf{\textcolor{vertCongo}{a- Acteurs humains}}

\vspace{0.2cm}
Nous avons identifié quatre principaux acteurs humains :

\begin{itemize}
	\item \textbf{Visiteur :} utilisateur non encore enregistré sur la plateforme. Son unique interaction avec « SALISA » est l'inscription, qui lui permet de créer un compte et de choisir son rôle ;
	...
	\item \textbf{Administrateur :} utilisateur chargé d'administrer la plateforme, de vérifier les identités, de gérer les signalements et de configurer le système.
\end{itemize}

\vspace{0.3cm}
\noindent\textbf{\textcolor{vertCongo}{b- Acteurs systèmes}}

\vspace{0.2cm}
En modélisation UML, on désigne par acteur système tout composant logiciel extérieur au système étudié qui interagit avec lui par l'échange de données ou de services. Ces acteurs sont représentés avec le stéréotype \textit{$\langle\langle$system$\rangle\rangle$} pour les distinguer des acteurs humains. Nous en avons identifié deux pour « SALISA » :
...
\begin{itemize}
	...
	\item \textbf{Service de notifications :} regroupe le service d'e-mail transactionnel et l'API SMS. « SALISA » lui envoie des instructions pour délivrer les codes OTP, les alertes et les messages aux utilisateurs.
\end{itemize}
...
% ---------------------------------------------------------------
% NOTE SUR P2 - PROFIL PRESTATAIRE
% Dans SALISA, la notion de profil est propre au rôle de prestataire.
% Un profil prestataire est une vitrine professionnelle publique : portfolio,
% tarifs, zones d'intervention, compétences et badges de certification.
% Ces éléments n'ont de sens que pour celui qui propose des services.
% Le demandeur n'a pas de profil public : il publie des missions et paie.
% ---------------------------------------------------------------

\begin{table}[H]
	\caption{Cas d'utilisation du package P2 : Profil prestataire}
	\label{tab:cu_p2}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P2 : Profil prestataire}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
		...
		\hline
		\textbf{UC-10} & soumettre une demande de vérification d'identité (Prestataire, Administrateur) \\
		\hline
	\end{tabular}
\end{table}

\begin{table}[H]
	\caption{Cas d'utilisation du package P3 : Gestion des missions}
	\label{tab:cu_p3}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P3 : Gestion des missions}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
		...
		\hline
		\textbf{UC-12} & utiliser l'assistant IA pour la description de la mission (Demandeur) \\
		\hline
		\textbf{UC-13} & modifier ou clore une mission publiée (Demandeur) \\
		\hline
	\end{tabular}
\end{table}

\begin{table}[H]
	\caption{Cas d'utilisation du package P4 : Recherche et matching}
	\label{tab:cu_p4}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P4 : Recherche et matching}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
...
\begin{table}[H]
	\caption{Cas d'utilisation du package P5 : Messagerie et devis}
	\label{tab:cu_p5}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P5 : Messagerie et devis}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
...
\begin{table}[H]
	\caption{Cas d'utilisation du package P6 : Paiement}
	\label{tab:cu_p6}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P6 : Paiement}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
		\textbf{UC-23} & régler une mission via MTN MoMo ou Airtel Money (Demandeur, Service de paiement) \\
		\hline
		...
		\hline
		\textbf{UC-27} & demander un retrait (Prestataire) \\
		\hline
	\end{tabular}
\end{table}

\begin{table}[H]
	\caption{Cas d'utilisation du package P7 : Notation et réputation}
	\label{tab:cu_p7}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P7 : Notation et réputation}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
		\textbf{UC-28} & laisser un avis après mission (Demandeur, Prestataire) \\
		\hline
		\textbf{UC-29} & signaler un avis abusif (Demandeur, Prestataire) \\
		\hline
	\end{tabular}
\end{table}

\begin{table}[H]
	\caption{Cas d'utilisation du package P8 : Notifications}
	\label{tab:cu_p8}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P8 : Notifications}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
		\textbf{UC-30} & recevoir des notifications multi-canaux (Demandeur, Prestataire, Service de notifications) \\
		\hline
		\textbf{UC-31} & configurer ses préférences de notification (Demandeur, Prestataire) \\
		\hline
	\end{tabular}
\end{table}

\begin{table}[H]
	\caption{Cas d'utilisation du package P9 : Administration}
	\label{tab:cu_p9}
	\centering
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		\hline
		\multicolumn{2}{|c|}{\cellcolor{vertCongo}\textcolor{white}{\textbf{Package P9 : Administration}}} \\
		\hline
		\rowcolor{vertCongo}
		\textcolor{white}{\textbf{Cas d'utilisation}} & \textcolor{white}{\textbf{Définition}} \\
		\hline
		\textbf{UC-32} & accéder au tableau de bord de modération (Administrateur) \\
		\hline
		\textbf{UC-33} & valider ou rejeter une vérification d'identité (Administrateur) \\
		\hline
		\textbf{UC-34} & gérer les signalements (Administrateur) \\
		\hline
		\textbf{UC-35} & suspendre un compte utilisateur (Administrateur) \\
		\hline
	\end{tabular}
\end{table}
...
Les relations entre cas d'utilisation permettent de structurer et de clarifier les dépendances entre les fonctionnalités du système \cite{roques_uml}. On en distingue deux types principaux. La relation \textbf{$\langle\langle$include$\rangle\rangle$} indique qu'un cas d'utilisation est toujours exécuté dans le cadre d'un autre : par exemple, UC-01 (s'inscrire) inclut systématiquement UC-02 (valider le code OTP), car on ne peut pas créer de compte sans valider le code reçu par SMS ; de même, UC-21 (accepter un devis) inclut UC-23 (régler une mission via MTN MoMo ou Airtel Money), car l'acceptation d'un devis déclenche toujours le processus de paiement. La relation \textbf{$\langle\langle$extend$\rangle\rangle$}, quant à elle, indique qu'un cas d'utilisation est exécuté de façon optionnelle dans certaines conditions : par exemple, UC-11 (publier une mission) peut optionnellement étendre vers UC-12 (utiliser l'assistant IA pour la description de la mission), selon le choix du demandeur.

\vspace{0.4cm}
Pour illustrer ces dépendances avec précision, nous avons d'abord représenté chaque package dans son propre diagramme de cas d'utilisation. Ces neuf diagrammes détaillés permettent de visualiser clairement, pour chaque domaine fonctionnel, les acteurs impliqués et les relations entre les cas d'utilisation. Les figures~\ref{fig:cu_p1} à~\ref{fig:cu_p9} illustrent ces neuf diagrammes.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p1.png}
	\caption{Diagramme de cas d'utilisation - Package 1 : Authentification}
	\label{fig:cu_p1}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p2.png}
	\caption{Diagramme de cas d'utilisation - Package 2 : Profil prestataire}
	\label{fig:cu_p2}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p3.png}
	\caption{Diagramme de cas d'utilisation - Package 3 : Gestion des missions}
	\label{fig:cu_p3}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p4.png}
	\caption{Diagramme de cas d'utilisation - Package 4 : Recherche et matching}
	\label{fig:cu_p4}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p5.png}
	\caption{Diagramme de cas d'utilisation - Package 5 : Messagerie et devis}
	\label{fig:cu_p5}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p6.png}
	\caption{Diagramme de cas d'utilisation - Package 6 : Paiement}
	\label{fig:cu_p6}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p7.png}
	\caption{Diagramme de cas d'utilisation - Package 7 : Notation et réputation}
	\label{fig:cu_p7}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p8.png}
	\caption{Diagramme de cas d'utilisation - Package 8 : Notifications}
	\label{fig:cu_p8}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{diagramme_cu_p9.png}
	\caption{Diagramme de cas d'utilisation - Package 9 : Administration}
	\label{fig:cu_p9}
\end{figure}

\vspace{0.4cm}
Une fois les neuf packages détaillés individuellement, il est utile de disposer d'une vue d'ensemble du système. C'est le rôle du diagramme de packages présenté à la figure~\ref{fig:diag_packages}. Ce diagramme montre les neuf domaines fonctionnels de « SALISA » et leurs relations avec les acteurs. Il met notamment en évidence une dépendance commune à tous les packages : chacun d'entre eux requiert que l'utilisateur soit préalablement authentifié, ce qui est représenté par des relations $\langle\langle$include$\rangle\rangle$ convergeant vers P1 - Authentification.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{diagramme_packages.png}
	\caption{Diagramme de packages de « SALISA »}
	\label{fig:diag_packages}
\end{figure}
...
\noindent\textbf{\textcolor{vertCongo}{a- Description de UC-01 : s'inscrire via numéro de téléphone}}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{3.5cm}|p{10cm}|}
		...
		\hline
		\textbf{Objectif} & détaille les étapes permettant à un Visiteur de s'inscrire afin de devenir Utilisateur \\
		\hline
		\textbf{Acteur principal} & Visiteur \\
		\hline
		\textbf{Acteurs secondaires} & Système SALISA, Service de notifications \\
		\hline
		\textbf{Date} & le 23/04/2026 \\
		\hline
		\textbf{Responsables} & Christophe MASSAMBA \& Deo BATA \\
		\hline
		\textbf{Version} & 1.0 \\
		\hline
		...
		\begin{enumerate}
			...
			\item Le visiteur choisit son rôle : prestataire ou demandeur (UC-03).
...
\vspace{0.5cm}
\noindent\textbf{\textcolor{vertCongo}{b- Description de UC-11 : publier une mission}}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{3.5cm}|p{10cm}|}
		...
		\hline
		\textbf{Objectif} & détaille les étapes permettant à un Demandeur de publier une mission \\
		\hline
...
La figure~\ref{fig:seq_paiement} illustre le diagramme de séquence du processus de paiement d'une mission (UC-20, UC-21, UC-23 et UC-26). Ce scénario débute par l'envoi d'un devis par le prestataire, qui en constitue le véritable déclencheur.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{diagramme_sequence_paiement.png}
	\caption{Diagramme de séquence - envoi de devis, paiement et validation de mission}
	\label{fig:seq_paiement}
\end{figure}

\subsubsection{Diagramme d'activités}

La figure~\ref{fig:act_publication} présente le diagramme d'activités du processus de publication d'une mission et de sélection d'un prestataire, impliquant le Demandeur, le Système SALISA et le Prestataire.
...
La figure~\ref{fig:act_paiement} illustre le diagramme d'activités du processus de paiement mobile.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{diagramme_activites_paiement.png}
	\caption{Diagramme d'activités - processus de paiement mobile}
...
\vspace{0.2cm}
\noindent\textbf{\textcolor{vertCongo}{Gestion des comptes}}

\begin{itemize}
	\item RG-001 : un numéro de téléphone ne peut être associé qu'à un seul compte ;
	\item RG-002 : un compte est associé à un seul rôle, soit Prestataire, soit Demandeur ;
...
\noindent\textbf{\textcolor{vertCongo}{Gestion des missions et des prestataires}}

\begin{itemize}
	\item RG-005 : un profil prestataire n'est visible dans la recherche qu'à partir de 70\% de complétion ;
	\item RG-006 : un prestataire avec un compte gratuit ne peut postuler qu'à 3 missions par mois ;
	\item RG-007 : une mission sans activité depuis 30 jours est archivée automatiquement ;
	\item RG-008 : au maximum 10 prestataires sont notifiés par mission (les 10 meilleurs scores de matching).
\end{itemize}

\noindent\textbf{\textcolor{vertCongo}{Gestion des paiements}}

\begin{itemize}
	\item RG-009 : la commission de « SALISA » est de 3\% du montant total de chaque transaction ;
	\item RG-010 : le montant minimum d'une transaction est de 2 000 FCFA ;
	\item RG-011 : le paiement est déclenché uniquement après acceptation du devis par le demandeur ;
	\item RG-012 : les fonds sont transférés au prestataire après validation de la mission par le demandeur.
\end{itemize}

\noindent\textbf{\textcolor{vertCongo}{Gestion des avis}}

\begin{itemize}
	\item RG-013 : un avis ne peut être laissé qu'après une mission avec transaction validée ;
	\item RG-014 : le délai pour laisser un avis est de 14 jours après la validation de la mission ;
	\item RG-015 : les avis sont définitifs et ne peuvent jamais être supprimés par le prestataire ou le demandeur.
\end{itemize}
...
La figure~\ref{fig:diag_objets} illustre un exemple d'instanciation du système « SALISA », correspondant au scénario où un demandeur publie une mission, un prestataire y répond avec un devis, et le paiement est effectué via MTN MoMo.
...
« SALISA » repose sur une \textbf{architecture 3-tiers} de type \textbf{client-serveur}. Concrètement, cela signifie que le système est découpé en trois niveaux bien séparés : le premier est la \textbf{couche de présentation}, c'est-à-dire l'interface que l'utilisateur voit dans son navigateur ; le deuxième est la \textbf{couche de logique métier}, qui regroupe les traitements effectués côté serveur ; et le troisième est la \textbf{couche de données}, qui assure le stockage et la gestion des informations. Cette séparation claire entre les trois niveaux facilite la maintenance du système, permet de faire évoluer chaque couche indépendamment des autres, et améliore la sécurité en évitant que le client accède directement à la base de données. Cette architecture est organisée autour de cinq composants principaux.
...
Le \textbf{Service de notifications} est un worker asynchrone qui envoie les alertes via trois canaux : les notifications push PWA, les e-mails et les SMS.
