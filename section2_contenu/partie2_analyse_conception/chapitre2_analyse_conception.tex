...
\begin{table}[H]
	...
	\begin{tabular}{|p{3cm}|p{10.5cm}|}
		...
		\hline
		\textbf{UC-27} & demander un retrait Mobile Money (Prestataire) \\
		\hline
	\end{tabular}
...
\begin{figure}[H]
	...
	\caption{Diagramme d'activités - processus de paiement via Mobile Money}
...
La figure~\ref{fig:diag_objets} illustre un exemple d'instanciation du système « SALISA », correspondant au scénario où un demandeur publie une mission, un prestataire y répond avec un devis, et le paiement est effectué via Mobile Money.
