...
\begin{itemize}
	...
	\item \textbf{Administrateur :} utilisateur connecté chargé d'administrer la plateforme, de vérifier les identités, de gérer les signalements et de configurer le système.
\end{itemize}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P1 : Authentification}
	\label{fig:cu_p1}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P2 : Profil prestataire}
	\label{fig:cu_p2}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P3 : Gestion des missions}
	\label{fig:cu_p3}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P4 : Recherche et matching}
	\label{fig:cu_p4}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P5 : Messagerie et devis}
	\label{fig:cu_p5}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P6 : Paiement}
	\label{fig:cu_p6}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P7 : Notation et réputation}
	\label{fig:cu_p7}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P8 : Notifications}
	\label{fig:cu_p8}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagramme de cas d'utilisation - P9 : Administration}
	\label{fig:cu_p9}
\end{figure}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{4.5cm}|c|c|c|}
		...
		\hline
		UC-28 & laisser un avis & Élevée & Faible & 1 \\
		\hline
		...
		\hline
		UC-27 & demander un retrait & Basse & Faible & 3 \\
		\hline
	\end{tabular}
...
La figure~\ref{fig:seq_inscription} illustre le diagramme de séquence du cas d'utilisation UC-01 (s'inscrire via numéro de téléphone). Le système « SALISA » est représenté comme une boîte noire unique, conformément au niveau d'abstraction de l'analyse.
...
La figure~\ref{fig:act_paiement} illustre le diagramme d'activités du processus de paiement via Mobile Money.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{diagramme_activites_paiement.png}
	\caption{Diagramme d'activités - processus de paiement via paiement mobile}
...
La figure~\ref{fig:diag_objets} illustre un exemple d'instanciation du système « SALISA », correspondant au scénario où un demandeur publie une mission, un prestataire y répond avec un devis, et le paiement est effectué via paiement mobile.
