% Voici le fichier section1_preliminaires/sommaire.tex
...
\vspace{0.3cm}
\lignesom{\textbf{Première Partie : Présentation Générale}}{\pagerefmoinsun{chap:structure_sujet}}

\vspace{0.2cm}
\lignesomindent{Chapitre I : La structure d'accueil et le sujet}{\pageref{chap:structure_sujet}}

\vspace{0.3cm}
\lignesom{\textbf{Deuxième Partie : Analyse et Conception}}{\pagerefmoinsun{chap:etude_preliminaire}}
...
\vspace{0.3cm}
\lignesom{\textbf{Troisième Partie : Évaluation et Réalisation du Projet}}{\pagerefmoinsun{chap:evaluation}}
